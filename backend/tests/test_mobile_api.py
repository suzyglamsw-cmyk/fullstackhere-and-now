...
class TestAuthEndpoints:
    """Test authentication endpoints for mobile app"""
    ...
    def test_register_requires_age_confirmation(self, api_client):
        ...
        assert "18" in detail or "age" in detail or "older" in detail, f"Expected age-related error, got: {data}"
    ...
    def test_login_endpoint_exists(self, api_client, registered_user):
    ...
    def test_login_response_structure(self, api_client, registered_user):
    ...
    def test_profile_update_endpoint(self, api_client, registered_user):
    ...
    def test_profile_update_requires_auth(self, api_client):
...
class TestMobilePushEndpoints:
    ...
    def auth_token(self, api_client):
        """Get authentication token for push tests"""
        unique_email = f"push_test_{int(time.time())}@example.com"
        
        # Register a new user
        response = api_client.post(f"{BASE_URL}/api/auth/register", json={
            "email": unique_email,
            "password": TEST_PASSWORD,
            "display_name": "PushTestUser",
            "age_confirmed": True
        })
        ...
        pytest.skip("Could not get auth token for push tests")
    
    def test_mobile_push_register_endpoint_exists(self, api_client, auth_token):
    ...
    def test_mobile_push_register_requires_token(self, api_client, auth_token):
    ...
    def test_mobile_push_register_requires_auth(self, api_client):
    ...
    def test_mobile_push_unregister_endpoint_exists(self, api_client, auth_token):
    ...
    def test_mobile_push_unregister_requires_auth(self, api_client):
    ...
    def test_mobile_push_register_idempotent(self, api_client, auth_token):
...
class TestMobileAppFileStructure:
    """Verify mobile app file structure exists"""
    
    def test_mobile_screens_exist(self):
    ...
    def test_api_utility_file_exists(self):
    ...
    def test_push_notifications_file_exists(self):
...
class TestMobileAPIEndpointsInApiJs:
    """Verify mobile API utility has all required endpoints"""
    
    def test_api_js_has_auth_endpoints(self):
    ...
    def test_api_js_has_push_endpoints(self):
    ...
    def test_api_js_has_venues_endpoints(self):
